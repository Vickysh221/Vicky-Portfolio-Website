...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  "/agentic-design-development/ai-interior-system": {
    ...
    subtitle: "Agentic Design & Development · AI Interior",
    year: "2025",
    desc: "Reframing AI interior design from 'generate a room' to 'understand a lifestyle' — building semantic structure between user, space, and furniture before generation.",
    parent: "/agentic-design-development",
    color: "#8b7db5",
  },
