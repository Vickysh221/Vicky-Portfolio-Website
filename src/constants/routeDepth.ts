...
export const SLIDE_COUNTS: Record<string, number> = {
  ...
  '/agentic-design-development/language-diary': 6,
...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  "/agentic-design-development": {
    ...
    subPages: [
      ...
      { route: "/agentic-design-development/ai-interior-system", label: { zh: 'AI 室内设计系统的问题重构与交互定义', en: 'Problem Reframing and Interaction Definition for an AI Interior Design System' }, numeral: "VI" },
      { route: "/agentic-design-development/personal-os", label: { zh: 'personal OS 的探索进行时', en: 'Personal OS: An Ongoing Exploration' }, numeral: "VII" },
      { route: "/web-design-develop", label: { zh: 'AI coding 网页设计和开发', en: 'AI Coding Web Design and Development' }, numeral: "VIII" },
    ],
  },
