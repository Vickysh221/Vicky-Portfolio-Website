...
export const ROUTE_DEPTH: Record<string, number> = {
  ...
  "/agentic-design-development/aha-moment": -15500,
  ...
  "/agentic-design-development/personal-os": -16650,
...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  "/agentic-design-development": {
    ...
    subPages: [
      ...
      { route: "/agentic-design-development/aha-moment", label: { zh: '共享记忆驱动的语言学习 Aha 时刻', en: 'Shared-Memory Aha Moments for Language Learning' }, numeral: "II" },
      { route: "/agentic-design-development/fuli-plus", label: { zh: '面向地毯生成的AI协作设计系统', en: 'AI Collaborative Design System for Rug Generation' }, numeral: "III" },
      { route: "/agentic-design-development/driving-authority-contracts", label: { zh: '当车开始像同伴一样观察人时', en: 'When the Car Starts Observing Like a Companion' }, numeral: "IV" },
      { route: "/agentic-design-development/agentic-driving", label: { zh: '驾驶专家，还是个性化驾驶员？', en: 'Driving Expert, or Personalized Driver?' }, numeral: "V" },
      { route: "/agentic-design-development/simo-agent-system", label: { zh: 'SIMO Agent System 概念设计', en: 'SIMO Agent System Concept Design' }, numeral: "VI" },
      ...
      { route: "/agentic-design-development/personal-os", label: { zh: 'personal OS 的探索进行时', en: 'Personal OS: An Ongoing Exploration' }, numeral: "VIII" },
      { route: "/web-design-develop", label: { zh: 'AI coding 网页设计和开发', en: 'AI Coding Web Design and Development' }, numeral: "IX" },
    ],
  },
  ...
  "/agentic-design-development/personal-os": {
    title: { zh: 'personal OS 的探索进行时', en: 'Personal OS: An Ongoing Exploration' },
    subtitle: { zh: 'Agentic Design & Development · Personal Methodology', en: 'Agentic Design & Development · Personal Methodology' },
    year: "2026",
    desc: {
      zh: '把 Personal OS 定义为 right aspects of memory × right aspects of agents 形成的身份切片协调机制，并用两个可复用的 agent skill 展示它如何进入判断与写回。',
      en: 'Defines Personal OS as an identity-slice coordination mechanism formed by right aspects of memory × right aspects of agents, then shows how two reusable agent skills turn it into judgment and writeback.',
    },
    parent: "/agentic-design-development",
    color: "#8b7db5",
  },
  ...
  "/agentic-design-development/aha-moment": {
    title: { zh: '共享记忆驱动的语言学习 Aha 时刻', en: 'Shared-Memory Aha Moments for Language Learning' },
