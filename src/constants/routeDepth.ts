...
export const SLIDE_COUNTS: Record<string, number> = {
  ...
  '/agentic-design-development/personal-os': 2,
...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  "/agentic-design-development/personal-os": {
    ...
    year: "2026",
    desc: {
      zh: '用两个可复用的 agent skill 展示一套 personal OS 方法论：上游判断一个方向是否成立，下游把研究判断沉淀成可追溯写回。',
      en: 'A personal-OS methodology shown through two reusable agent skills: one judges whether a direction should exist, and the other turns research judgment into traceable writeback.',
    },
    parent: "/agentic-design-development",
    color: "#8b7db5",
  },
